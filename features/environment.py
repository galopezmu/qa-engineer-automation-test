...
from lib.pages.kayak_pages import (
    BestMomentTravelPage,
    BusinessPage,
    CarsPage,
    CytiBreaksPage,
    DirectPage,
...
def before_all(context):
    ...
    # Quitamos el tiempo de carga, ya que es demasiado corto
    # y dejamos el que viene por defecto
    ...
    # Añadimos las áginas al context de behave
    ...
    pages = [
        ...
        ("stays", StaysPage),
        ("cars", CarsPage),
        ("city_breaks", CytiBreaksPage),
        ("explore", ExplorePage),
        ("news", NewsPage),
        ("direct", DirectPage),
        ("best_moment_travel", BestMomentTravelPage),
        ("business", BusinessPage),
        ("trips", TripsPage),
    ]

    context.all_contexts = {name: page(context) for name, page in pages}
